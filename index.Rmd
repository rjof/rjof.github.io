...
##if ( !require('coronavirus') ) { install.packages('coronavirus') ; require('coronavirus') ; }
if ( !require('covid19italy') ) { install.packages('covid19italy') ; require('covid19italy') ; }
##install.packages('~/Downloads/fst_0.9.2.tgz',repos=NULL,type='source')
##if ( !require('tidyfst') ) { install.packages('tidyfst') ; require('tidyfst') ; }
##if ( !require('xml2') ) { install.packages('~/Downloads/xml2_1.3.1.tgz' ,repos=NULL,type='source',configure.vars="INCLUDE_DIR=/usr/local/opt/libxml2/include/libxml2 LIB_DIR=/usr/local/opt/libxml2/lib/") ; require('xml2') }
##if ( !require('rversions') ) { install.packages('~/Downloads/rversions_2.0.1.tgz',repos=NULL,type='source') ; require('rversions') }

#checks if there is data update on the Github version
##coronavirus::update_datasets(silence = TRUE)
##update.packages("coronavirus")
##devtools::install_github("covid19r/coronavirus")

##data(coronavirus)
##data(italy_total)
coronavirus = read.csv2('~/Projects/github/coronavirus_dashboard/data/coronavirus_dataset.csv', sep=',',stringsAsFactors = F, header = T)
